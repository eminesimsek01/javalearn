...
public class C01_HashMap {
    ...
    public static void main(String[] args) {
        ...
        hm.put(null,"222 Euro");//tekrarlı key değerine value update edilir
        hm.put("Ebay",null);//value değeri null atanabilir
        hm.put("Saturn","300 Euro");
        hm.put("Vatan","111 Euro");
        hm.put("Apple store","333 Euro");
        hm.put("Apple store","500 Euro");//Apple store key'deki value 333 Euro iken 500 Euro olarak update etti. Aynı key kullanılırsa üzerine atama yapılır.
        hm.put("MediaMarkt","183 Euro");
        //map sout komutuna parametre olarak print edilir.
        System.out.println(hm);//{null=222 Euro, Saturn=300 Euro, Ebay=null, Apple store=500 Euro, MediaMarkt=183 Euro, Amazon=296 Euro, Vatan=111 Euro}
