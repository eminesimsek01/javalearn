...
public class Q2_Question {
    public static void main(String[] args) {
        ...
        //Java Math.Random Class 0.0 ile 1.0 arasında değer üretir
        for(int i=0; i<10; i++){
            System.out.println((i+1)+" . sayı"+ Math.random()*10);
        }
        System.out.println();
        //Random Class-> java.util.Random //Sayı üretmeye 1'den başlar
        Random random =new Random();
        for(int i=0; i<10; i++){
            int sayı=random.nextInt(5);//1 ile 100 arasında
