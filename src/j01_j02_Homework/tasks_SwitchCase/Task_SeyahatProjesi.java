   ...
   todo    Frankfurt girildiyse,
      ...
      "Rota = Köln" yazdırın.
       ...
       case:1  ise
        ...
        switch (hedef) {
            case "FRANKFURT":
                System.out.println("Bilet bir kişilik mi, yoksa iki kişilik mi?");
                int kisi=scan.nextInt();
                switch(kisi) {
                    case 1:
                        System.out.println("Frankurta 1 kişilik seyahat ücreti :"+15+" euro");
                        System.out.println("Seyahat ücretinizi ödeyebilirsiniz");
                        System.out.println("Yatırmak istediğiniz miktarı girin: ");
                        double yatırılanmiktar=scan.nextDouble();
                        double bakiye=yatırılanmiktar-15;
                        System.out.println("Para üstünüz : "+bakiye+" Euro İyi yolculuklar dileriz ");
                        break;
                    case 2:
                        System.out.println("Frankfurta iki kişilik seyahat ücreti :"+30+" euro");
                        System.out.println("Seyahat ücretinizi ödeyebilirsiniz");
                        System.out.println("Yatırmak istediğiniz miktarı girin: ");
                        double yatırılan=scan.nextDouble();
                        double bakıye=yatırılan-30;
                        System.out.println("Para üstünüz : "+bakıye+" Euro İyi yolculuklar dileriz ");
                        break;
                }
                break;
            ...
            int kisiS=scan.nextInt();
                ...
                {
                case 1:
                    System.out.println("Kölne 1 kişilik seyahat ücreti :"+20+" euro");
                    System.out.println("Seyahat ücretinizi ödeyebilirsiniz");
                    System.out.println("Yatırmak istediğiniz miktarı girin: ");
                    double yatırılan=scan.nextDouble();
                    double bakıye=yatırılan-20;
                    System.out.println("Para üstünüz : "+bakıye+" Euro İyi yolculuklar dileriz ");
                    break;
                case 2:
                    System.out.println("Kölne iki kişilik seyahat ücreti :"+40+" euro");
                    System.out.println("Seyahat ücretinizi ödeyebilirsiniz");
                    System.out.println("Yatırmak istediğiniz miktarı girin: ");
                    double yatrılan=scan.nextDouble();
                    double bakye=yatrılan-40;
                    System.out.println("Para üstünüz : "+bakye+" Euro İyi yolculuklar dileriz ");
                    break;
            }
