...
public class _16_if_else_statement_with_logic_operators5 {
    ...
    double a=45;
    if (a%5==5&&a%8==0){
        System.out.println( "This number can be divided 5 and 8 without a remaining");
    }
    if (a%10==5&&a%9==0){
        System.out.println(" This number is divisible with 9 and has a remaining 5 when divided by ten ");
    }
