...
public class C01_HashSet {
     ...
     */
        HashSet<String>hs=new HashSet<>();//boş bir hasset
        HashSet<String>hs1=new HashSet<>(Arrays.asList("Ercan","Yakup","Adem","Rukiye","Nur"));//boş bir hasset
        //Set Print Etme
        ...
        HashSet<String>hs2=new HashSet<>(Arrays.asList("Güzel gören güzel düşünür"));
        System.out.println("hs2 = " + hs2);
        hs1.addAll(hs2);
        System.out.println("hs1 = " + hs1);

        System.out.println("hs1.remove(\"asıktır\") = " + hs1.remove("asıktır"));//olmayan eleman silinince false
        hs1.remove("gören");//Var olan silinince true verir
        System.out.println("hs1 = " + hs1);
        ...
        System.out.println("hs2.contains(\"gören\") = " + hs2.contains("gören"));//false
        System.out.println("hs2.hashCode() = " + hs2.hashCode());//hs2.hashCode() = -1471056749
