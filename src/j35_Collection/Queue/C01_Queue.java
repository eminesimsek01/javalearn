...
public class C01_Queue {
    public static void main(String[] args) {
          /*
      Queue coll. interface olduğu için child class olan LinkedList ve PriorityQueue
      ile obj uretilir.
       ...
       */
        ...
        System.out.println("q1.element() = " + q1.element());// Cebrail// // element() -> ilk elemanı silmeden return eder.
        System.out.println("q1.peek() = " + q1.peek());// Cebrail////peek()-> copt-paste gibi ilk elemanı return eder ama silmez
