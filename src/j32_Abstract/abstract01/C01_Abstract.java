...
public class C01_Abstract {
    ...
    Bu gibi durumlarda parent class'daki method'a body tanımlamak ram ve memoey acısından gereksizdir.
    ...
    4- Abs method sadece abs Class'da tanımlanabilir kesinlikle concrete class'da abs method tanımlanamaz.
            ama abs class'da concrete emthod tanımlanabilir
    5- Abs Class içinde hem abs method hem de concrete method ve variable tanımlanabilir.
    6- Bir concerete child class parent abs class extend ettiğinde abs method'ları implement etnek zorunda
        ama concerete methodlar isteğe göre override edilir.
    7- Parent child ilşkisi olan abstract class'lar abs method'ları implement etmek zorunda değil
    8- Parent olan abs class birden çok concrete  veya abs child class extends edebilir,
