...
public class C01_Arrays {
    ...
    public static void main(String[] args) {
        ...
        //task-> sayıArr elemanlarından çift index elemanları print eden code create ediniz.
        for (int i = 0; i < sayıArr.length; i += 2) {
            System.out.println(sayıArr[i] + " ");
        }

        //task-> isimArr 5 harfli elemanlarından oluşan arryın elemanlarını print eden code create ediniz.
        ...
        System.out.println(Arrays.toString(sayıArr));//sıralam öncesi sayıArr->[34, 43, 34 99, 0]
        Arrays.sort(sayıArr);//sayıArr k->b sıralandı
        System.out.println(Arrays.toString(sayıArr));//sıralam sonrası sayıArr-> [0, 34, 43, 99]
